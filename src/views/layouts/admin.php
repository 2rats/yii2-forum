...
<body class="d-flex flex-column h-100">
    ...
    <header id="header">
        <?php
        NavBar::begin([
            'brandLabel' => 'yii2-forum - Administration',
            'brandUrl' => Url::to('/' . ForumModule::getInstance()->id . '/admin'),
            'options' => [
        ...
        $navItems = [];
        $navItems[] = ['label' => Yii::t('app', 'Back to forum'), 'url' => ['/' . ForumModule::getInstance()->id]];
                        ...
                        <div class="col-11">
                            <?= Breadcrumbs::widget([
                                'homeLink' => [
                                    ...
                                    'url' => Url::to('/' . ForumModule::getInstance()->id . '/admin')
